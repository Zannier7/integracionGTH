                                ...
                                $.post(url, data, function (objJson) {
                                    ...
                                    if (lista.length) {
                                        ...
                                        for (var i = 0; i < lista.length; i++) {
                                            ...
                                            m += '<td>' + lista[i].remu + '</td>';
                                            m += '<td>' + lista[i].bono + '</td>';
                                            m += '<td>' + lista[i].boni + '</td>';
                                            m += '<td>' + lista[i].bev + '</td>';
                                            m += '<td>' + lista[i].stotal + '</td>';
                                            m += '<td>' + lista[i].banco + '</td>';
                                            m += '<td>' + lista[i].ncuenta + '</td>';
                                            m += '<td>' + lista[i].cci + '</td>';
                                            m += '<td>' + lista[i].ccosto + '</td>';
                                            m += '<td>' + lista[i].ccosto2 + '</td>';
                                            m += '<td>' + lista[i].seduc + '</td>';
                                            m += '<td>' + lista[i].codreg + '</td>';
                                            m += '<td>' + lista[i].descreg + '</td>';
                                            m += '<td>' + lista[i].codtins + '</td>';
                                            m += '<td>' + lista[i].desctins + '</td>';
                                            m += '<td>' + lista[i].codins + '</td>';
                                            m += '<td>' + lista[i].descins + '</td>';                                            
                                            m += '<td>' + lista[i].codcar + '</td>';
                                            m += '<td>' + lista[i].desccar + '</td>';
                                            m += '</tr>';
                                        }
